...
class Chase2AndEscape:
    
    def __init__(self, speed_pursuer1, speed_pursuer2, speed_evader, mass_pursuer1=1, mass_pursuer2=1,  mass_evader=1, \
    ...
    def reset(self):
        ...
        obs_p1 = get_obs_p(self.pos_p1, self.vel_p1, self.pos_p2, self.vel_p2, self.pos_e, self.vel_e)
        obs_p2 = get_obs_p(self.pos_p2, self.vel_p2, self.pos_p1, self.vel_p1, self.pos_e, self.vel_e)
        obs_e = get_obs_e(self.pos_e, self.vel_e, self.pos_p1, self.vel_p1, self.pos_p2, self.vel_p2)
                
        return obs_p1, obs_p2, obs_e
    
    
    def step(self, action_p1, action_p2, action_e, num_step):
        ...
        pos_adv1, _, _, _ = get_order_adv(self.pos_e, self.pos_p1, self.vel_p1, self.pos_p2, self.vel_p2)        
        ...
        next_obs_p1 = get_obs_p(next_pos_p1, next_vel_p1, next_pos_p2, next_vel_p2, next_pos_e, next_vel_e)
        next_obs_p2 = get_obs_p(next_pos_p2, next_vel_p2, next_pos_p1, next_vel_p1, next_pos_e, next_vel_e)
        next_obs_e = get_obs_e(next_pos_e, next_vel_e, next_pos_p1, next_vel_p1, next_pos_p2, next_vel_p2)
        ...
        return next_obs_p1, next_obs_p2, next_obs_e, reward_p1, reward_p2, reward_e, done


def get_obs_p(pos_p1, vel_p1, pos_p2, vel_p2, pos_e, vel_e):
...
def get_obs_e(pos_e, vel_e, pos_p1_tmp, vel_p1_tmp, pos_p2_tmp, vel_p2_tmp):
    
    pos_p1, vel_p1, pos_p2, vel_p2 = get_order_adv(pos_e, pos_p1_tmp, vel_p1_tmp, pos_p2_tmp, vel_p2_tmp)
...
def get_order_adv(pos_own, pos_adv1_tmp, vel_adv1_tmp, pos_adv2_tmp, vel_adv2_tmp):
...
def get_reward_pursuer(abs_pos_own, abs_pos_mate, abs_pos_adv, reward_share):
...
def get_reward_evader(abs_pos_own, abs_pos_adv1, abs_pos_adv2):
