...
if __name__ == '__main__':
    ...
    filename_model_p1 = "../model/c3ae/reward_" + args.in_sh + "/p1_" + args.speed_p + ".pth"
    filename_model_p2 = "../model/c3ae/reward_" + args.in_sh + "/p2_" + args.speed_p + ".pth"
    filename_model_p3 = "../model/c3ae/reward_" + args.in_sh + "/p3_" + args.speed_p + ".pth"
    filename_model_e = "../model/c3ae/reward_" + args.in_sh + "/e_" + args.speed_p + ".pth"
